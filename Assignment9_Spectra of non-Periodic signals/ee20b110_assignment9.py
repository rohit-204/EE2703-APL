...
# Defining a function to plot a spectrum graph.
...
#  Question.1.
# We are ploting a spectrum of sin(sqrt(2)t), in the most basic approximate way.
...
# The below piece of code is ploting a spectrum of sin(sqrt(2)t), in a better way after windowing.
...
# We are ploting a spectrum of cos^3(0.86t), with and without windowing.
...
#  We are finding the values of w0 and delta from the spectrum of the signal.
...
# We are finding the same for a noisy signal.
...
# We are ploting the spectrum of a "chirped" signal.
...
# We are ploting a surface plot with respect to t and w.
t_array = split(t,16)
Y_mag = zeros((16,64))
Y_phase = zeros((16,64))
